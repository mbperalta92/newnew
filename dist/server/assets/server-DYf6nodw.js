...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-_OYRSTru.js");
...
const manifest = {
  "e649e195f8fe8ce3fce2dae352e70518034e36d8d1faee40936f29c0c777896e": {
    functionName: "sendTicketEmail_createServerFn_handler",
    importer: () => import("./email-CRGy7PzJ.js")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-xjl3LMxX.js").then((n2) => n2.r),
    import("./start-CM1tmoBU.js"),
