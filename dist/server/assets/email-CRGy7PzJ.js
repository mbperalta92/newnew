import { a0 as TSS_SERVER_FUNCTION, a1 as createServerFn } from "./server-DYf6nodw.js";
...
async function render(node) {
  let render2;
  try {
    ({ render: render2 } = await import("./render_resend_false-MiC__Smr.js"));
  } catch {
...
const sendTicketEmail_createServerFn_handler = createServerRpc({
  id: "e649e195f8fe8ce3fce2dae352e70518034e36d8d1faee40936f29c0c777896e",
  name: "sendTicketEmail",
  filename: "src/lib/email.ts"
}, (opts) => sendTicketEmail.__executeServer(opts));
const sendTicketEmail = createServerFn({
  method: "POST"
}).handler(sendTicketEmail_createServerFn_handler, async (ctx) => {
  const data = ctx.data;
...
export {
  sendTicketEmail_createServerFn_handler
};
