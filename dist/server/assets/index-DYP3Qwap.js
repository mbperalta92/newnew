import { r as reactExports, U as jsxRuntimeExports, a0 as TSS_SERVER_FUNCTION, a2 as getServerFnById, a1 as createServerFn } from "./server-DYf6nodw.js";
import { t as toast } from "./router-xjl3LMxX.js";
...
const Crosshair = createLucideIcon("crosshair", __iconNode$i);
const __iconNode$h = [
  [
    "path",
    {
...
const FileCheckCorner = createLucideIcon("file-check-corner", __iconNode$g);
const __iconNode$f = [
  [
    "path",
    {
...
const Laptop = createLucideIcon("laptop", __iconNode$c);
...
function Values() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "relative py-28", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-muted-foreground", children: "Acreditamos que confiança não se compra com slogans — constrói-se com método, clareza e responsabilidade." })
    ] }),
...
const sendTicketEmail = createServerFn({
  method: "POST"
}).handler(createSsrRpc("e649e195f8fe8ce3fce2dae352e70518034e36d8d1faee40936f29c0c777896e"));
...
function BudgetForm() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "orcamentos", className: "relative py-28", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto px-6", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-12 rounded-3xl border-gold p-1.5 shadow-[var(--shadow-elegant)]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-[1.35rem] bg-[#0B1325]/90 p-8 md:p-10", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-1.5 rounded-full bg-[#1a2540] overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-full bg-gold-gradient transition-all duration-500", style: { width: `${progress}%` } }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-8 min-h-[320px]", children: step === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "animate-in fade-in duration-300 space-y-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
...
function Footer() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "relative border-t border-border/60 mt-10", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-6 py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center md:items-start gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: logo, alt: "REPFIX Serviços Técnicos", className: "h-14 w-auto" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "https://www.repfix.pt", className: "flex items-center gap-2.5 text-sm text-foreground/90 hover:text-[#FCF6BA] transition-colors", children: [
