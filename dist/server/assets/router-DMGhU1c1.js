...
const appCss = "/assets/styles-CxRqf9cs.css";
function NotFoundComponent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center bg-background px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md text-center", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-muted-foreground", children: "A página que procura não existe ou foi movida." }),
...
function ErrorComponent({ error, reset }) {
  ...
  const router = useRouter();
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center bg-background px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-xl font-semibold tracking-tight text-foreground", children: "A página não carregou" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-muted-foreground", children: "Ocorreu um erro do nosso lado. Pode tentar atualizar a página ou voltar ao início." }),
...
const $$splitComponentImporter = () => import("./index-BUu1JahE.js");
const Route2 = createFileRoute("/")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Diagnóstico transparente, reparação e relatórios técnicos para informática, eletrónica e eletrodomésticos. Soluções para empresas e clientes particulares."
    }, {
      property: "og:title",
      content: "REPFIX — Serviços Técnicos"
    }, {
      property: "og:description",
      content: "Parceria técnica rigorosa e transparente. Para a sua empresa ou para o seu equipamento pessoal."
    }]
  })
});
